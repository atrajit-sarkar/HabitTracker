...
private fun FirestoreHabit.toHabit(): Habit {
    return Habit(
        ...
        dayOfMonth = dayOfMonth,
        monthOfYear = monthOfYear,
        notificationSoundId = "",  // Will be populated from Firestore or use default
        notificationSoundName = notificationSound,  // Use the stored name
        notificationSoundUri = "",  // Will be populated or use default
        avatar = HabitAvatar(
